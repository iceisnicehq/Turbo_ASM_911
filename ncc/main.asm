...
.data
	...
	curr_byte    db    0 ; хранит опкод команды, которую декодим
	instruction  db    50 dup (0) ; строка которую наполняем постепенно, а потом записываем в файл
	com_data     db    5000 dup (0)
