...
.data
inputCmdFile        db      "com.com", 0
resultFile          db      "result.asm", 0
fileHandle          dw      ?
...
handleEsSeg:
    mov     currentSegReg, offset segEs
    jmp     cmdProcessing
handleCsSeg:
    mov     currentSegReg, offset segCs
    jmp     cmdProcessing
handleSsSeg:
    mov     currentSegReg, offset segSs
    jmp     cmdProcessing
handleDsSeg:
    mov     currentSegReg, offset segDs
    jmp     cmdProcessing
handleFsSeg:
    mov     currentSegReg, offset segFs
    jmp     cmdProcessing
handleGsSeg:
    mov     currentSegReg, offset segGs
    jmp     cmdProcessing
